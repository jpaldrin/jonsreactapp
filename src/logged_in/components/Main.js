...
import families from "../dummy_data/family";
...
function Main(props) {
  ...
  const fetchFeatureSection = useCallback(() => {
    ...
    for (let index = 0; index < families.length; index++) {
      ...
      const section = {
        ...
        text: family.text,
        mddelay: family.mddelay,
        smdelay: family.smdelay
      };
      featureSection.push(section);
    }
      setFeatureSection(featureSection);
    }, [setFeatureSection]);
  ...
  const fetchRandomMessages = useCallback(() => {
    ...
    for (let i = 0; i < iterations; i += 1) {
      ...
      const message = {
        ...
        date: curUnix,
        text: "Application for: " + person.department,
      };
  ...
  const selectDashboard = useCallback(() => {
    smoothScrollTop();
    document.title = "John's - Dashboard";
  ...
  const selectEmployee = useCallback(()=> {
    smoothScrollTop();
    document.title = "John's - Employee's";
  ...
  const selectSubscription = useCallback(() => {
    smoothScrollTop();
    document.title = "John's - Subscription";
    ...
    <Fragment>
      ...
      <main className={classNames(classes.main)}>
        <Routing
          ...
          setPosts={setPosts}
          setFeatureSection ={setFeatureSection}
        />
      </main>
    </Fragment>
  );
